...
[BG_row, BG_col] = size(D1_BG);
[FG_row, FG_col] = size(D1_FG);
...
cov_BG = (D1_BG' - U_BG)*((D1_BG' - U_BG)')./BG_row;
cov_FG = (D1_FG' - U_FG)*((D1_FG' - U_FG)')./FG_row;
...
ppgr=1-ppch;
error.ML.D1(1)=errorch*ppch+errorgr*ppgr;