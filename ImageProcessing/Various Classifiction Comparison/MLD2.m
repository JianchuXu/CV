...
[BG_row, BG_col] = size(D2_BG);
[FG_row, FG_col] = size(D2_FG);
...
cov_BG = (D2_BG' - U_BG)*((D2_BG' - U_BG)')./BG_row;
cov_FG = (D2_FG' - U_FG)*((D2_FG' - U_FG)')./FG_row;
...
ppgr=1-ppch;
error.ML.D2(1)=errorch*ppch+errorgr*ppgr;