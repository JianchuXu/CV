...
[BG_row, BG_col] = size(D4_BG);
[FG_row, FG_col] = size(D4_FG);
...
cov_BG = (D4_BG' - U_BG)*((D4_BG' - U_BG)')./BG_row;
cov_FG = (D4_FG' - U_FG)*((D4_FG' - U_FG)')./FG_row;
...
ppgr=1-ppch;
error.ML.D4(1)=errorch*ppch+errorgr*ppgr;